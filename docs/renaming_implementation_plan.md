...
| T008 | `instances`、`generate_blocks` | PLANNED |
| T009 | `modules`、`ports` | PLANNED |
| T010 | `typedefs`、`struct_types` | PLANNED |
| T011 | `struct_fields`、`union_fields` | PLANNED |
| T012 | `interfaces`、`interface_instances` | PLANNED |
| T013 | `interface_ports`、`modports`、`modport_ports` | PLANNED |
| T014 | 全部表内类别组合、完整映射和回归 | PLANNED |
