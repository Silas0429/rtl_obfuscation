...
| `rename_nets` | net | `wire ready` | `Net` | 全部绑定到该 net 的引用 | `true` |
| `rename_variables` | 模块/过程变量 | `logic masked_data`、`int i` | `Variable` | 普通引用、select、层次引用 | `true` |
