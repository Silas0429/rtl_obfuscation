...
本目录保存统一三入口架构、project-root 能力和类别策略的设计方案、路线图与历史决策。
它们用于维护代码和理解变更背景，不是用户操作说明。

- [`three_mode_refactor_plan.md`](three_mode_refactor_plan.md)：单文件、filelist、project-root 的统一架构。
