...
- 实现状态：R1、R2、R3-A、R3-B、R3-C/T046、R3-D/T047、R3-E/T048、R3-F/T049 已验收；R3-G/T050 已冻结为下一活动任务；本文不是活动任务合同
...
- 当前实现任务：[`docs/tasks/T050_rate_selected_execution.md`](tasks/T050_rate_selected_execution.md)
...
- 后续 R3 任务再补最终 CLI metrics adapter 和三入口接线；
