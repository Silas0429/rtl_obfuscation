...
- 实现状态：R1、R2、R3-A 已验收；R3-B T045 已冻结为下一活动任务；本文不是活动任务合同
...
- 当前实现任务：[`docs/tasks/T045_mapping_vnext_naming.md`](tasks/T045_mapping_vnext_naming.md)
...
- 后续R3任务再接一次性文件编辑、strict gate、decrypt、metrics和 compact Formal；不得回到
  legacy inventory，也不得把这些步骤并入 T044/T045；
