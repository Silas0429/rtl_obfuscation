...
- 实现状态：R1、R2-A、R2-B 已验收；R2-C T042 已冻结为下一活动任务；本文不是活动任务合同
...
- 当前实现任务：[`docs/tasks/T042_symbol_graph_genvars.md`](tasks/T042_symbol_graph_genvars.md)
...
- R2-D 在 T042 验收后另建任务迁移 module value parameter/localparam、dimension、generate condition
  和 named override；该任务同时冻结 `internal/module_abi/top_boundary`，不与 T042 混合；
