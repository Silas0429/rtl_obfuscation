...
- 实现状态：R1、R2 已验收；R3-A T044 已冻结为下一活动任务；本文不是活动任务合同
...
- 当前实现任务：[`docs/tasks/T044_rewrite_policy_selection.md`](tasks/T044_rewrite_policy_selection.md)
...
- 后续R3任务依次冻结mapping vNext/测试命名器，再接一次性文件编辑、strict gate、decrypt、metrics和
  compact Formal；不得回到legacy inventory或把这些步骤并入T044；
