...
- 实现状态：R1、R2、R3-A、R3-B、R3-C/T046 已验收；R3-D/T047 已冻结为下一活动任务；本文不是活动任务合同
...
- 当前实现任务：[`docs/tasks/T047_mapping_execution_envelope.md`](tasks/T047_mapping_execution_envelope.md)
...
- 后续 R3 任务只补 effective-line、coverage、plaintext leakage、rate selection 和 metrics；
