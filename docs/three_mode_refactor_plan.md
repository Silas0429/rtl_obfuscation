...
- 实现状态：R1、R2、R3-A、R3-B 已验收；R3-C T046 已冻结为下一活动任务；本文不是活动任务合同
...
- 当前实现任务：[`docs/tasks/T046_rewrite_vnext_roundtrip.md`](tasks/T046_rewrite_vnext_roundtrip.md)
...
- 后续 R3 任务只补最终 mapping execution envelope、per-file mapping、manifests 和 metrics；
